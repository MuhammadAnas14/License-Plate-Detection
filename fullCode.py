...
def detectPlate(imageFile,algo):
        ...
        imageFile="/home/anas/Desktop/VehicleNumberPlateRecognition/Images(Input)/"+imageFile
        #print(imageFile)
        image = cv2.imread(imageFile)
...
load =Image.open('/home/anas/Desktop/VehicleNumberPlateRecognition/icon_image.jpg')
